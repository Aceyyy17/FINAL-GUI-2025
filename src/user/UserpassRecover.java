 ...
 * @author MARITIME 1
 */
public class UserpassRecover extends javax.swing.JFrame {

    /**
     * Creates new form AdminDashBoard
     */
    public UserpassRecover() {
        initComponents();
    }
...
public boolean recoverycheck() {
    ...
    private void initComponents() {
        ...
        qt1.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        qt2.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        jPanel3.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, 90, 30));

        u_id.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        u_id.setText("ID");
        jPanel3.add(u_id, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 70, 30, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserpassRecover.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserpassRecover().setVisible(true);
            }
        });
    }
