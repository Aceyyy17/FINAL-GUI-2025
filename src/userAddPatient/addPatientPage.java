...
public class addPatientPage extends javax.swing.JFrame {
        ...
        if(rowIndex < 0){
            ...
            try{
                ...
                if(rs.next()){
                    ...
                    ap.p_id.setText(""+rs.getString("p_id"));
                    ap.p_fname.setText(""+rs.getString("p_fname"));
                    ap.p_lname.setText(""+rs.getString("p_lname"));
                    ap.address.setText(""+rs.getString("p_address"));
                    ap.p_num.setText(""+rs.getString("p_pnumber"));
                    ap.gender.setSelectedItem(""+rs.getString("p_gender"));
                    ap.addPatient.setEnabled(false);
                    ap.updatePatient.setEnabled(true);
                    ap.setVisible(true);
                    this.dispose();  
    ...
    private void viewMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_viewMouseClicked
        updatePatient vp = new updatePatient();
        vp.setVisible(true);
        this.dispose();
